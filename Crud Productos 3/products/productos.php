...
<div class="modal fade" id="ModalAñadir" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form form class="form" method="POST" action="app\ProductsController.php">
      <br>
            <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Nombre</span>
            <input type="name" class="form-control" name="name" placeholder="Nombre del Producto" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <br>
            <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Slug</span>
            <input type="slug" class="form-control" name="slug" placeholder="Slug del Producto" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <br>
            <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Descripción de producto</span>
            <input type="text" class="form-control" name="description" placeholder="Descripcion del Producto" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <br>
            <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Feature</span>
            <input type="feature" class="form-control" name="feature" placeholder="Feature del Producto" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <br>
            <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">ID de Producto</span>
            <input type="text" class="form-control" name="brand_id" placeholder="ID del Producto" aria-label="Username" aria-describedby="basic-addon1">
            </div>
      ...
      <div class="modal-footer">
        ...
        <input type="hidden" name='action' action='create'>
      </div>
    </div>
  </div>
</div>
